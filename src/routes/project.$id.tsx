    ...
    <div className="flex h-screen flex-col bg-background text-foreground">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <main className="flex min-w-0 flex-1">
          <div className={showPreview ? "flex min-w-0 flex-1 flex-col" : "flex min-w-0 flex-1 flex-col"}>
            <Editor project={project} />
          </div>
          {showPreview && (
            <div className="hidden w-1/2 border-l border-border md:flex md:flex-col">
